...
class Tree:
        ...
        def __init__(self, nodes, clst=None, elst=None, plst=None):
                ...
                if clst is None and elst is None and plst is None:
                        pass
                else:
...
class TreeNode:
        ...
        def __init__(self, index, word, postag, deprel, headidx, label='N', level = 0):
